  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="{{asset('/loginUser')}}" method="post" id="loginForm">
        {{ csrf_field() }}
        <div class="mb-3">
          <input type="text" name="emailId" id="emailId" class="form-control" placeholder="Email" value="">
          
        </div>
        <div class="mb-3">
          <input type="password" name="pwd" id="pwd" class="form-control" placeholder="Password" value="">
        </div>
